        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(day, 30, GETDATE())"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobAds_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobAds_JobTypes_JobTypeId",
                        column: x => x.JobTypeId,
                        principalTable: "JobTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobAds_SalaryTypes_SalaryTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplications", x => new { x.JobAdId, x.CandidateId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSkills", x => new { x.JobAdId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_JobSkills_JobAds_JobAdId",
                        column: x => x.JobAdId,
                        principalTable: "JobAds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ExecutionDateTime",
                table: "AuditLogs",
                column: "ExecutionDateTime");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_Identity",
                table: "AuditLogs",
                column: "Identity");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobAds_JobId",
                table: "JobAds",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobAds_JobTypeId",
                table: "JobAds",
                column: "JobTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_JobAds_SalaryTypeId",
                table: "JobAds",
                column: "SalaryTypeId");
